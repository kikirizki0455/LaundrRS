...
$routes->delete('/home/delete_bahan/(:num)', 'Home::delete_bahan/$1');
$routes->get('/home/edit_pegawai/(:num)', 'Home::edit_pegawai/$1');
$routes->get('/home/edit_barang/(:num)', 'Home::edit_barang/$1');
$routes->get('/home/edit_bahan/(:num)', 'Home::edit_bahan/$1');
...
$routes->get('/data-pegawai', 'Home::data_pegawai');
$routes->get('/data-barang', 'Home::data_barang');
$routes->get('/data-bahan', 'Home::data_bahan');
